...
//            );
    ...
    private static function handleForAdoption(AdoptionEntity $adoptionEntity, AdopteesModel $adopteesModel): void
    {
        ...
        NamingDone::send(
            ...
            adoptionType: $adoptionEntity->getAdoptedProduct(),
            quantity: $adoptionEntity->getQuantity(),
            fiscalReceiptUrl: FiscalReceiptService::getURl($adopteesModel->getAdoptionUuid()),
            certificateUrl: CertificateService::getSanitizedURL($adopteesModel->getAdoptionUuid())
        );
    }
